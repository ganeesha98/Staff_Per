<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer_CreditLimit.aspx.cs" Inherits="Staff_Purchase_.Forms.Customer_CreditLimit" %>
...
<body>
    ...
    <div class="row">
        ...
        <div class="container">
            ...
            <br />
            <p style="font-size: 20px; text-align: center;"><B>Customer Credit Limit Adjustment</B></p>
        ...
        <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <asp:Button ID="btnUpdate" runat="server" Text="Update Limit" CssClass="btn btn-secondary auto-style328"
                    Style="border-color: #333333; background-color: #e8edea" OnClick="btnUpdate_Click"
                     Width="200px" OnClientClick="return validateFields();"/>
            ...
            <div class="col-sm-12" style="margin-left: 180px;">
                                    <label for="txtfixed" style="font-size: 12px; color: #f22307; display: block; margin: 0 auto; width: 100%; height: 20px;">
                                        * Please note. This Is Only For Customer Credit Limit Update</label>
                                </div> 
        ...
        <script type="text/javascript">
            function validateFields() {
                ...
                if (textBox10Value.trim() === '' || textBox11Value.trim() === '') {
                    alert('Please select customer code and change credit limit to save data.');
